    ...
    <section id="contact" className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center space-y-4 mb-12 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-hero">
            Let's Work Together
          </h2>
          <div className="w-12 sm:w-16 h-1 bg-primary rounded-full mx-auto"></div>
          <p className="text-base sm:text-lg text-body max-w-2xl mx-auto px-2">
        ...
        <div className="space-y-4 sm:space-y-6">
          {contactInfo.map((info) => (
            <a
              ...
              className="flex items-center gap-3 sm:gap-4 p-4 sm:p-5 bg-white rounded-xl shadow-md 
                         transition-all duration-300 ease-in-out 
                         hover:shadow-xl hover:scale-[1.02]"
            >
              <div className="flex-shrink-0 p-2 sm:p-3 bg-primary/10 rounded-lg text-primary">
                {info.icon}
              </div>
              <div>
                <div className="font-medium text-hero text-sm sm:text-base">{info.label}</div>
                <div className="text-body text-sm sm:text-base">{info.value}</div>
              </div>
            </a>
          ))}
        </div>
        ...
        <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-gray-50 rounded-xl border border-gray-200">
          <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
            ...
            <span className="font-medium text-hero text-sm sm:text-base">Available for Projects</span>
          </div>
